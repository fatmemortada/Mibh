  ...
  return (
    <>
      <HeroSection
        ...
        small
        bgImage={heroImages.prayerTimes}
      />

      {/* Monthly Prayer Time PDFs */}
      <section className="py-16 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            title="Monthly Namaz Timings 2026"
            subtitle="Download Prayer Schedules"
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <cite className="block mt-4 text-gold-light font-medium not-italic">
            — Holy Qur&apos;an, Surah An-Nisa (4:103)
          </cite>
        </div>
      </section>
    </>
